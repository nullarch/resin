...
import { rgb, colorNew, from_gradient, colorR, colorG, colorB, colorT, vizColor, vizFlag, vizNum } from "./color";
...
export const rt = {
  // viz S1/S2/S3 — 채널 기록 직전 정규화. codegen이 `$.plotColors[k][$.idx] =
  // rt.vizColor(...)` / `$.vizSeries[k][$.idx] = rt.vizFlag|vizNum(...)` 형태로만 소비한다.
  vizColor,
  vizFlag,
  vizNum,
  ta,
  ...
  label: {
    ...
    // viz S4 — 표시용 setter 승격 (drawing.ts setDisplayField 주석 참조).
    set_color: setDisplayField("color"),
    set_textcolor: setDisplayField("textcolor"),
    set_size: setDisplayField("size"),
    set_style: setDisplayField("style"),
    set_textalign: setDisplayField("textalign"),
    set_tooltip: setDisplayField("tooltip"),
    set_xloc: setDisplayField("xloc"),
    set_yloc: setDisplayField("yloc"),
  ...
  line: {
    ...
    set_xy1: lineSetXy1,
    set_xy2: lineSetXy2,
    // viz S4 — 표시용 setter 승격.
    set_color: setDisplayField("color"),
    set_width: setDisplayField("width"),
    set_style: setDisplayField("style"),
    set_extend: setDisplayField("extend"),
    set_xloc: setDisplayField("xloc"),
  ...
  box: {
    ...
    // viz S4 — 표시용 setter 승격 (text_* 세부는 텍스트/색만 — 나머지는 여전히 no-op).
    set_bgcolor: setDisplayField("bgcolor"),
    set_border_color: setDisplayField("border_color"),
    set_border_width: setDisplayField("border_width"),
    set_border_style: setDisplayField("border_style"),
    set_extend: setDisplayField("extend"),
    set_text: setDisplayField("text"),
    set_text_color: setDisplayField("text_color"),
